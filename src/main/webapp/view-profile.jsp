...
<%--        <ul class="list-group">--%>
<%--            <li class="list-group-item">--%>
<%--                <strong>Username:</strong> <%= request.getAttribute("username") %>--%>
<%--            </li>--%>
<%--            <li class="list-group-item">--%>
<%--                <strong>Email:</strong> <%= request.getAttribute("email") %>--%>
<%--            </li>--%>
<%--            <li class="list-group-item">--%>
<%--                <strong>Phone:</strong> <%= request.getAttribute("phone") %>--%>
<%--            </li>--%>
<%--            <li class="list-group-item">--%>
<%--                <strong>Address:</strong> <%= request.getAttribute("address") %>--%>
<%--            </li>--%>
<%--        </ul>--%>
<%--    </div>--%>
...
<%--    <!-- Profile Update Button -->--%>
<%--    <div class="text-center">--%>
<%--        <a href="update-profile?userId=<%= request.getAttribute("userId") %>" class="btn btn-primary">Update Profile</a>--%>
<%--    </div>--%>
<%--</div>--%>
...
<div class="container mt-5">
    <h2>Your Profile</h2>
    <p><strong>Username:</strong> <%= request.getAttribute("user_name") %></p>
    <p><strong>Email:</strong> <%= request.getAttribute("email") %></p>
    <a href="update-profile.jsp" class="btn btn-warning">Update Profile</a>
</div>
