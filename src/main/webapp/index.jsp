<%@ page import="lk.ijse.ecommercepos.dto.ProductDTO" %>
...
<div id="heroCarousel" class="carousel slide hero-carousel" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/WhatsApp Image 2025-01-26 at 12.15.13.jpeg" class="d-block w-100 h-100" alt="Slide 1">
        ...
        <div class="carousel-item">
            <img src="images/WhatsApp Image 2025-01-26 at 12.15.13 (1).jpeg" class="d-block w-100 " alt="Slide 2">
            <div class="carousel-caption d-md-block">
                <div class="search-container">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search for products...">
        ...
        <div class="carousel-item">
            <img src="images/WhatsApp Image 2025-01-26 at 12.15.14.jpeg" class="d-block w-100" alt="Slide 3">
            <div class="carousel-caption d-md-block">
                <div class="search-container">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search for products...">
